...
function Ta(a){for(;a.length;){var b=a.pop();a.pop()(b)}}function Ua(a){return this.fromWireType(A[a>>2])}var Va={},Wa={},Xa={};function Ya(a){if(void 0===a)return"_unknown";a=a.replace(/[^a-zA-Z0-9_]/g,"$");var b=a.charCodeAt(0);return 48<=b&&57>=b?"_"+a:a}function Za(a,b){a=Ya(a);return function(){null;return b.apply(this,arguments)}}
...
arguments.length+") - expected ("+Object.keys(G.rd).toString()+") parameters instead!");return I.apply(this,arguments)});var C=Object.create(x,{constructor:{value:p}});p.prototype=C;var G=new wb(r,p,C,z,u,f,k,q);u=new N(r,G,!0,!1);x=new N(r+"*",G,!1,!1);var D=new N(r+" const*",G,!1,!0);lb[a]={pointerType:x,je:D};Db(l,p);return[u,x,D]})},r:function(a,b,c,d,e,f,g,k){b=L(b);f=P(e,f);J([],[a],function(n){n=n[0];var q=n.name+"."+b,r={get:function(){Jb("Cannot access "+q+" due to unbound types",[c])},enumerable:!0,
configurable:!0};r.set=k?()=>{Jb("Cannot access "+q+" due to unbound types",[c])}:()=>{M(q+" is a read-only property")};Object.defineProperty(n.dd.constructor,b,r);J([],[c],function(v){v=v[0];var z={get:function(){return v.fromWireType(f(d))},enumerable:!0};k&&(k=P(g,k),z.set=l=>{var p=[];k(d,v.toWireType(p,l));Ta(p)});Object.defineProperty(n.dd.constructor,b,z);return[]});return[]})},n:function(a,b,c,d,e,f){0<b||ra();var g=Lb(b,c);e=P(d,e);J([],[a],function(k){k=k[0];var n="constructor "+k.name;
...
K(a,{name:c,fromWireType:d,argPackAdvance:8,readValueFromPointer:d},{xe:!0})},A:function(a,b){b=L(b);var c="std::string"===b;K(a,{name:b,fromWireType:function(d){var e=B[d>>2],f=d+4;if(c)for(var g=f,k=0;k<=e;++k){var n=f+k;if(k==e||0==y[n]){g=wa(g,n-g);if(void 0===q)var q=g;else q+=String.fromCharCode(0),q+=g;g=n+1}}else{q=Array(e);for(k=0;k<e;++k)q[k]=String.fromCharCode(y[f+k]);q=q.join("")}Ib(d);return q},toWireType:function(d,e){e instanceof ArrayBuffer&&(e=new Uint8Array(e));var f="string"==
typeof e;f||e instanceof Uint8Array||e instanceof Uint8ClampedArray||e instanceof Int8Array||M("Cannot pass non-string to std::string");var g=c&&f?ya(e):e.length;var k=zc(4+g+1),n=k+4;B[k>>2]=g;if(c&&f)xa(e,y,n,g+1);else if(f)for(f=0;f<g;++f){var q=e.charCodeAt(f);255<q&&(Ib(n),M("String has UTF-16 code units that do not fit in 8 bits"));y[n+f]=q}else for(f=0;f<g;++f)y[n+f]=e[f];null!==d&&d.push(Ib,k);return k},argPackAdvance:8,readValueFromPointer:Ua,kd:function(d){Ib(d)}})},u:function(a,b,c){c=
L(c);if(2===b){var d=Vb;var e=Wb;var f=Xb;var g=()=>Ca;var k=1}else 4===b&&(d=Yb,e=Zb,f=$b,g=()=>B,k=2);K(a,{name:c,fromWireType:function(n){for(var q=B[n>>2],r=g(),v,z=n+4,l=0;l<=q;++l){var p=n+4+l*b;if(l==q||0==r[p>>k])z=d(z,p-z),void 0===v?v=z:(v+=String.fromCharCode(0),v+=z),z=p+b}Ib(n);return v},toWireType:function(n,q){"string"!=typeof q&&M("Cannot pass non-string to C++ string type "+c);var r=f(q),v=zc(4+r+b);B[v>>2]=r>>k;e(q,v+4,r+b);null!==n&&n.push(Ib,v);return v},argPackAdvance:8,readValueFromPointer:Ua,
kd:function(n){Ib(n)}})},Dc:function(a,b,c,d,e,f){Sa[a]={name:L(b),Qd:P(c,d),pd:P(e,f),Zd:[]}},sc:function(a,b,c,d,e,f,g,k,n,q){Sa[a].Zd.push({qe:L(b),we:c,ue:P(d,e),ve:f,Ee:g,De:P(k,n),Fe:q})},pb:function(a,b){b=L(b);K(a,{ze:!0,name:b,argPackAdvance:0,fromWireType:function(){},toWireType:function(){}})},jb:function(){return!0},eb:function(){throw Infinity;},Cb:function(a,b,c){a=Pb(a);b=Rb(b,"emval::as");var d=[],e=Bb(d);B[c>>2]=e;return b.toWireType(d,a)},db:function(a,b,c,d){a=cc[a];b=Pb(b);c=bc(c);
a(b,c,null,d)},Ec:Ob,$a:function(a,b){var c=ec(a,b),d=c[0];b=d.name+"_$"+c.slice(1).map(function(g){return g.name}).join("_")+"$";var e=fc[b];if(void 0!==e)return e;var f=Array(a-1);e=dc((g,k,n,q)=>{for(var r=0,v=0;v<a-1;++v)f[v]=c[v+1].readValueFromPointer(q+r),r+=c[v+1].argPackAdvance;g=g[k].apply(g,f);for(v=0;v<a-1;++v)c[v+1].me&&c[v+1].me(f[v]);if(!d.ze)return d.toWireType(n,g)});return fc[b]=e},Yb:function(a,b){a=Pb(a);b=Pb(b);return Bb(a[b])},Ya:function(a){4<a&&(Q[a].Rd+=1)},Nb:function(a){return Bb(bc(a))},
rb:function(a){var b=Pb(a);Ta(b);Ob(a)},lb:function(a,b){a=Rb(a,"_emval_take_value");a=a.readValueFromPointer(b);return Bb(a)},a:function(){ra("")},ib:()=>performance.now(),Sa:function(a){t.activeTexture(a)},Ra:function(a,b){t.attachShader(R[a],S[b])},Qa:function(a,b,c){t.bindAttribLocation(R[a],b,wa(c))},Pa:function(a,b){35051==a?t.Od=b:35052==a&&(t.wd=b);t.bindBuffer(a,kc[b])},Sb:function(a,b){t.bindFramebuffer(a,lc[b])},Rb:function(a,b){t.bindRenderbuffer(a,mc[b])},yb:function(a,b){t.bindSampler(a,
pc[b])},Oa:function(a,b){t.bindTexture(a,nc[b])},kc:function(a){t.bindVertexArray(oc[a])},gc:function(a){t.bindVertexArray(oc[a])},Na:function(a,b,c,d){t.blendColor(a,b,c,d)},Ma:function(a){t.blendEquation(a)},La:function(a,b){t.blendFunc(a,b)},Eb:function(a,b,c,d,e,f,g,k,n,q){t.blitFramebuffer(a,b,c,d,e,f,g,k,n,q)},Ka:function(a,b,c,d){2<=m.version?c&&b?t.bufferData(a,y,d,c,b):t.bufferData(a,b,d):t.bufferData(a,c?y.subarray(c,c+b):b,d)},Ja:function(a,b,c,d){2<=m.version?c&&t.bufferSubData(a,b,y,
d,c):t.bufferSubData(a,b,y.subarray(d,d+c))},Qb:function(a){return t.checkFramebufferStatus(a)},Ia:function(a){t.clear(a)},Ha:function(a,b,c,d){t.clearColor(a,b,c,d)},Ga:function(a){t.clearStencil(a)},Va:function(a,b,c,d){return t.clientWaitSync(qc[a],b,(c>>>0)+4294967296*d)},Fa:function(a,b,c,d){t.colorMask(!!a,!!b,!!c,!!d)},Ea:function(a){t.compileShader(S[a])},Da:function(a,b,c,d,e,f,g,k){2<=m.version?t.wd||!g?t.compressedTexImage2D(a,b,c,d,e,f,g,k):t.compressedTexImage2D(a,b,c,d,e,f,y,k,g):t.compressedTexImage2D(a,
...
xa:function(a,b){for(var c=0;c<a;c++){var d=A[b+4*c>>2],e=kc[d];e&&(t.deleteBuffer(e),e.name=0,kc[d]=null,d==t.Od&&(t.Od=0),d==t.wd&&(t.wd=0))}},Pb:function(a,b){for(var c=0;c<a;++c){var d=A[b+4*c>>2],e=lc[d];e&&(t.deleteFramebuffer(e),e.name=0,lc[d]=null)}},wa:function(a){if(a){var b=R[a];b?(t.deleteProgram(b),b.name=0,R[a]=null):T(1281)}},Ob:function(a,b){for(var c=0;c<a;c++){var d=A[b+4*c>>2],e=mc[d];e&&(t.deleteRenderbuffer(e),e.name=0,mc[d]=null)}},xb:function(a,b){for(var c=0;c<a;c++){var d=
A[b+4*c>>2],e=pc[d];e&&(t.deleteSampler(e),e.name=0,pc[d]=null)}},va:function(a){if(a){var b=S[a];b?(t.deleteShader(b),S[a]=null):T(1281)}},Bb:function(a){if(a){var b=qc[a];b?(t.deleteSync(b),b.name=0,qc[a]=null):T(1281)}},ua:function(a,b){for(var c=0;c<a;c++){var d=A[b+4*c>>2],e=nc[d];e&&(t.deleteTexture(e),e.name=0,nc[d]=null)}},jc:function(a,b){for(var c=0;c<a;c++){var d=A[b+4*c>>2];t.deleteVertexArray(oc[d]);oc[d]=null}},fc:function(a,b){for(var c=0;c<a;c++){var d=A[b+4*c>>2];t.deleteVertexArray(oc[d]);
oc[d]=null}},ta:function(a){t.depthMask(!!a)},sa:function(a){t.disable(a)},ra:function(a){t.disableVertexAttribArray(a)},qa:function(a,b,c){t.drawArrays(a,b,c)},dc:function(a,b,c,d){t.drawArraysInstanced(a,b,c,d)},bc:function(a,b,c,d,e){t.Xd.drawArraysInstancedBaseInstanceWEBGL(a,b,c,d,e)},$b:function(a,b){for(var c=vc[a],d=0;d<a;d++)c[d]=A[b+4*d>>2];t.drawBuffers(c)},pa:function(a,b,c,d){t.drawElements(a,b,c,d)},cc:function(a,b,c,d,e){t.drawElementsInstanced(a,b,c,d,e)},ac:function(a,b,c,d,e,f,g){t.Xd.drawElementsInstancedBaseVertexBaseInstanceWEBGL(a,
b,c,d,e,f,g)},Wb:function(a,b,c,d,e,f){t.drawElements(a,d,e,f)},oa:function(a){t.enable(a)},na:function(a){t.enableVertexAttribArray(a)},Ab:function(a,b){return(a=t.fenceSync(a,b))?(b=ea(qc),a.name=b,qc[b]=a,b):0},ma:function(){t.finish()},la:function(){t.flush()},Mb:function(a,b,c,d){t.framebufferRenderbuffer(a,b,c,mc[d])},Lb:function(a,b,c,d,e){t.framebufferTexture2D(a,b,c,nc[d],e)},ka:function(a){t.frontFace(a)},ja:function(a,b){wc(a,b,"createBuffer",kc)},Kb:function(a,b){wc(a,b,"createFramebuffer",
lc)},Jb:function(a,b){wc(a,b,"createRenderbuffer",mc)},wb:function(a,b){wc(a,b,"createSampler",pc)},ia:function(a,b){wc(a,b,"createTexture",nc)},ic:function(a,b){wc(a,b,"createVertexArray",oc)},ec:function(a,b){wc(a,b,"createVertexArray",oc)},Ib:function(a){t.generateMipmap(a)},ha:function(a,b,c){c?A[c>>2]=t.getBufferParameter(a,b):T(1281)},ga:function(){var a=t.getError()||uc;uc=0;return a},Hb:function(a,b,c,d){a=t.getFramebufferAttachmentParameter(a,b,c);if(a instanceof WebGLRenderbuffer||a instanceof
...
6];e[g+7]=f[k+7];e[g+8]=f[k+8];e[g+9]=f[k+9];e[g+10]=f[k+10];e[g+11]=f[k+11];e[g+12]=f[k+12];e[g+13]=f[k+13];e[g+14]=f[k+14];e[g+15]=f[k+15]}}else e=F.subarray(d>>2,d+64*b>>2);t.uniformMatrix4fv(U(a),!!c,e)}},rc:function(a){a=R[a];t.useProgram(a);t.le=a},qc:function(a,b){t.vertexAttrib1f(a,b)},pc:function(a,b){t.vertexAttrib2f(a,F[b>>2],F[b+4>>2])},oc:function(a,b){t.vertexAttrib3f(a,F[b>>2],F[b+4>>2],F[b+8>>2])},nc:function(a,b){t.vertexAttrib4f(a,F[b>>2],F[b+4>>2],F[b+8>>2],F[b+12>>2])},Ub:function(a,
b){t.vertexAttribDivisor(a,b)},Tb:function(a,b,c,d,e){t.vertexAttribIPointer(a,b,c,d,e)},mc:function(a,b,c,d,e,f){t.vertexAttribPointer(a,b,c,!!d,e,f)},lc:function(a,b,c,d){t.viewport(a,b,c,d)},Wa:function(a,b,c,d){t.waitSync(qc[a],b,(c>>>0)+4294967296*d)},t:function(a){var b=y.length;a>>>=0;if(2147483648<a)return!1;for(var c=1;4>=c;c*=2){var d=b*(1+.2/c);d=Math.min(d,a+100663296);var e=Math;d=Math.max(a,d);e=e.min.call(e,2147483648,d+(65536-d%65536)%65536);a:{try{sa.grow(e-za.byteLength+65535>>>
16);Ea();var f=1;break a}catch(g){}f=void 0}if(f)return!0}return!1},gb:function(a,b){var c=0;Gc().forEach(function(d,e){var f=b+c;e=B[a+4*e>>2]=f;for(f=0;f<d.length;++f)Aa[e++>>0]=d.charCodeAt(f);Aa[e>>0]=0;c+=d.length+1});return 0},hb:function(a,b){var c=Gc();B[a>>2]=c.length;var d=0;c.forEach(function(e){d+=e.length+1});B[b>>2]=d;return 0},mb:function(){return 52},Za:function(){return 70},kb:function(a,b,c,d){for(var e=0,f=0;f<c;f++){var g=B[b>>2],k=B[b+4>>2];b+=8;for(var n=0;n<k;n++){var q=y[g+
n],r=Ic[a];0===q||10===q?((1===a?oa:pa)(va(r,0)),r.length=0):r.push(q)}e+=k}B[d>>2]=e;return 0},Xa:function(a,b){t.bindFramebuffer(a,lc[b])},x:function(a,b){xc(a,b)},m:Sc,h:Tc,k:Uc,p:Vc,ab:Wc,bb:Xc,o:Yc,j:Zc,b:$c,d:ad,e:bd,y:cd,cb:dd,fb:function(a,b,c,d){return Nc(a,b,c,d)}};
...
function Vc(a,b,c,d,e){var f=X();try{return O(a)(b,c,d,e)}catch(g){Z(f);if(g!==g+0)throw g;W(1,0)}}function Sc(a,b){var c=X();try{return O(a)(b)}catch(d){Z(c);if(d!==d+0)throw d;W(1,0)}}function Yc(a){var b=X();try{O(a)()}catch(c){Z(b);if(c!==c+0)throw c;W(1,0)}}function dd(a,b,c,d,e,f,g,k,n){var q=X();try{O(a)(b,c,d,e,f,g,k,n)}catch(r){Z(q);if(r!==r+0)throw r;W(1,0)}}function ad(a,b,c,d){var e=X();try{O(a)(b,c,d)}catch(f){Z(e);if(f!==f+0)throw f;W(1,0)}}
